...
public int pmatchupdate(P_matchVO vo);
public int teammatchupdate(TeammatchVO vo);
public String teamno();
public List<Mmatchlistnmember> matchmanagerlist(Mmatchlistnmember vo); 
public RfieldVO fielddetailupdate3(RfieldVO vo);
public List<MmatchlistVO>updatemmatch(MmatchlistVO vo);
public List<MmatchlistVO> mmatchsearch(String vo);
public TeammatchVO teammatchsearch(String vo);
public List<MmatchnmatchVO> matchresult(MmatchnmatchVO vo);
