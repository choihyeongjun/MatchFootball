...
<td><label>제목</label><input type="text" id="toMsgTitle" name="m_title" required="required">  </td>
<td><label>받는 사람</label><input type ="text" name="to_id" value="${msg.to_id}" required="required"><button type='button' id="findID">id찾기</button></td>
</tr>
<tr>
<td colspan="3">
<textarea cols="100%" rows="10" id="toMsgCon" name="m_con" required="required"></textarea>
</td>
</tr>
<tr>
