...
<body>
	...
	<div class="social-links">
		<div class="social-links__wrapper" align="center">
			<ul>
				<li style="width: 80px; float:left; margin-left: 35%" ><a href="https://ask.tottenhamhotspur.com/hc/en-us"
					target="_self"><img
						src="https://tot-tmp.azureedge.net/media/11674/ask-spurs-2.png?anchor=center&amp;mode=crop&amp;width=500"
						data-src="https://tot-tmp.azureedge.net/media/11674/ask-spurs-2.png?anchor=center&amp;mode=crop&amp;width=500"
						alt="" data-set="true"></a></li>
				<li style="width: 80px; float:left;"><a href="https://www.facebook.com/TottenhamHotspur/"
					target="_blank"><img
						...
						alt="" data-set="true"></a></li>
				<li style="width: 80px; float:left;"><a href="https://www.instagram.com/spursofficial/"
					target="_blank"><img
				...
				<li style="width: 80px; float:left;"><a href="https://twitter.com/SpursOfficial" target="_blank"><img
						...
						alt="" data-set="true"></a></li>
				<li style="width: 80px; float:left;"><a href="https://www.youtube.com/user/spursofficial"
					target="_self"><img
						...
						alt="" data-set="true"></a></li>
				<li style="width: 80px; float:left;"><a href="https://www.snapchat.com/add/spursofficial"
					target="_blank"><img
	...
	<div class="hygiene-links">
		<div class="hygiene-links__wrapper">
			<ul>
				<li><a href="/information/contact-us/" target="_blank"
					style="text-decoration: none">Contact Us</a></li>
				<li><a href="/information/cookie-policy/" target="_blank"
					style="text-decoration: none">Cookie Policy</a></li>
				<li><a href="/information/privacy-policy/" target="_blank"
					style="text-decoration: none">Privacy Policy</a></li>
				<li><a href="/information/terms-and-conditions/"
					target="_blank" style="text-decoration: none">Terms and
						Conditions</a></li>
				<li><a
					href="https://ask.tottenhamhotspur.com/hc/en-us/categories/200990832-My-Account"
					target="_self" style="text-decoration: none">My Account Help</a></li>
			</ul>
		</div>
	</div>
</footer>
