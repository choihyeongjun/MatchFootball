		...
		<ul class="navbar-nav ml-auto ml-md-0">
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu dropdown-menu-right"
					...
					<a class="dropdown-item" href="#">세팅</a> <a class="dropdown-item"
						href="#">엑티비티 로그</a>
					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="#">유저관리</a> <a class="nav-link"
									href="#">팀관리</a> <a class="nav-link" href="#">매니저</a>
							</nav>
						</div>
			...
			<main>
				<div class="container-fluid">
					...
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="#">경기일정표</a></li>
						<li class="breadcrumb-item active">일별 경기일정</li>
					</ol>
					<div class="card mb-4">
						<div class="card-body">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table mr-1"></i> 팀페이지</div>
