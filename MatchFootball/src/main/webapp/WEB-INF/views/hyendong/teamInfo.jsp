	  ...
	  <c:if test="${sessionScope.id ne null }">
		...
		<div align="center" style="padding-bottom: 606px">
						...
						<tbody>
							<c:forEach items="${teamMembers}" var="teamMembers">
								<tr>
									...
									<td><input type="text" value=${teamMembers.id } name="id"></td>
									<td><button type="submit"  onclick="javascript: form.action='${pageContext.request.contextPath}/memberOut'">추방</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</form>
			...
			<div style="float: bottom">
				...
				<button type="submit" class="btn btn-primary" onclick="location.href='teamUpdate'">팀 정보 변경</button>
				</c:if>
			</div>
		</div>
