...
<meta charset="utf-8">
		...
		<!-- Bootstrap -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/scripts/bootstrap/bootstrap.min.css">
		<!-- IonIcons -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/scripts/ionicons/css/ionicons.min.css">
		<!-- Toast -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/scripts/toast/jquery.toast.min.css">
		<!-- OwlCarousel -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/scripts/owlcarousel/dist/assets/owl.carousel.min.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/scripts/owlcarousel/dist/assets/owl.theme.default.min.css">
		<!-- Magnific Popup -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/scripts/magnific-popup/dist/magnific-popup.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/scripts/sweetalert/dist/sweetalert.css">
		<!-- Custom style -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/style.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/skins/all.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dong/demo.css">
</head>
<body>
<section class="home first" style="padding-top: 217px;">
				...
				<div class="row">
					<div class="col-md-8 col-sm-12 col-xs-12">
						...
						<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1500px, 0px, 0px); transition: all 0s ease 0s; width: 6000px;"><div class="owl-item cloned" style="width: 750px;"><div class="item">
								...
								<article class="featured">
									<div class="overlay"></div>
									<figure style="background-image: url(&quot;images/news/img04.jpg&quot;); background-size: cover; background-repeat: no-repeat; background-position: center center;">
								...
								<article class="featured">
									<div class="overlay"></div>
									<figure style="background-image: url(&quot;images/news/img14.jpg&quot;); background-size: cover; background-repeat: no-repeat; background-position: center center;">
									...
									<article class="article col-md-12">
										<div class="inner">
											...
											<div class="padding">
												...
												<footer>
													<a href="#" class="love"><i class="ion-android-favorite-outline"></i> <div>1,263</div></a>
									...
									<article class="article col-md-12">
										<div class="inner">
											...
											<div class="padding">
												...
												<footer>
													<a href="#" class="love"><i class="ion-android-favorite-outline"></i> <div>1,083</div></a>
													<a class="btn btn-primary more" href="single.html">
														<div>More</div>
														<div><i class="ion-ios-arrow-thin-right"></i></div>
													</a>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article" data-current="2" style="overflow: hidden;">
									<div style="height:332px;" id="vs_inner_0"><article class="article-mini" data-list="2" style="display: block;">
										<div class="inner">
											<figure>
												<a href="single.html">
									...
									</article><article class="article-mini" data-list="5" style="display: block;">
										<div class="inner">
											<figure>
												<a href="single.html">
										...
										<div class="inner">
											<figure>
												<a href="single.html">
													<img src="${pageContext.request.contextPath}/resources/css/dong/images/news/img08.jpg" alt="Sample Article">
												</a>
											</figure>
											<div class="padding">
							...
							<article class="col-md-12 article-list">
								<div class="inner">
									...
									<div class="details">
										...
										<footer>
											<a href="#" class="love"><i class="ion-android-favorite-outline"></i> <div>4,209</div></a>
											<a class="btn btn-primary more" href="single.html">
												<div>More</div>
												<div><i class="ion-ios-arrow-thin-right"></i></div>
											</a>
					...
					<div class="col-xs-6 col-md-4 sidebar" id="sidebar">
						...
						<aside>
							...
							<div class="aside-body">
								...
								<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1080px;"><div class="owl-item active" style="width: 360px;"><li><a data-youtube-id="SBjQ9tuuTJQ" data-action="magnific"><figure><div class="duration">0:00</div><div class="play"><i class="ion-play"></i></div></figure>	 <div class="desc">  <h2 class="title loading"></h2>  <div class="author loading"></div></div></a></li></div><div class="owl-item" style="width: 360px;"><li><a data-youtube-id="9cVJr3eQfXc" data-action="magnific"><figure><div class="duration">0:00</div><div class="play"><i class="ion-play"></i></div></figure>	 <div class="desc">  <h2 class="title loading"></h2>  <div class="author loading"></div></div></a></li></div><div class="owl-item" style="width: 360px;"><li><a data-youtube-id="DnGdoEa1tPg" data-action="magnific"><figure><div class="duration">0:00</div><div class="play"><i class="ion-play"></i></div></figure>	 <div class="desc">  <h2 class="title loading"></h2>  <div class="author loading"></div></div></a></li></div></div></div><div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots disabled"></div></ul>
							</div>
						</aside>
						<aside id="sponsored">
			...
			<!-- JS -->
			<script src="${pageContext.request.contextPath}/resources/css/dong/jquery.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/jquery.migrate.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/scripts/bootstrap/bootstrap.min.js"></script>
			<script>var $target_end=$(".best-of-the-week");</script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/scripts/jquery-number/jquery.number.min.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/scripts/owlcarousel/dist/owl.carousel.min.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/scripts/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/scripts/easescroll/jquery.easeScroll.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/scripts/sweetalert/dist/sweetalert.min.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/scripts/toast/jquery.toast.min.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/demo.js"></script>
			<script src="${pageContext.request.contextPath}/resources/css/dong/e-magz.js"></script>
</body>
</html>